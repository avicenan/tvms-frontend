        ...
        <div className="grid gap-6 sm:grid-cols-2">
          <div className="space-y-3">
            <div className="relative rounded-lg overflow-hidden border bg-muted flex items-center justify-center">
              <img src={`https://api.etilang.web.id/storage/${ticket?.violation?.violation_evidence}`} alt="Traffic violation photo 1" className="object-contain max-h-[300px] w-full" loading="lazy" />
          ...
          <div className="space-y-3">
            <div className="relative aspect-video overflow-hidden rounded-lg border bg-muted flex items-center justify-center">
              <img src={`https://api.etilang.web.id/storage/${ticket?.violation?.number_evidence}`} alt="Traffic violation photo 2" className="object-contain max-h-[300px] w-full" loading="lazy" />
              <div className="absolute bottom-2 right-2">
                <Badge className="bg-black/70 hover:bg-black/70 transition-colors">
                  <Camera className="h-3 w-3 mr-1" aria-hidden="true" />
