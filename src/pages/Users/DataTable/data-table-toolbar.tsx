  ...
  return (
    <div className="flex items-center justify-between">
      <div className="flex flex-1 items-center space-x-2">
        <Input placeholder="Cari NIP atau nama..." value={(table.getColumn("nip")?.getFilterValue() as string) ?? ""} onChange={(event) => table.getColumn("nip")?.setFilterValue(event.target.value)} className="h-8 w-[150px] lg:w-[250px]" />
